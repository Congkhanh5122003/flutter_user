...
import 'package:baiflutter/controllers/home_controller.dart';
...
import 'package:baiflutter/views/home_screen/components/featured_button.dart';
import 'package:baiflutter/views/home_screen/search_screen.dart';
import 'package:baiflutter/widget.common/home_buttons.dart';
                            ...
                            child: FutureBuilder(
                              ...
                              builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                                if (!snapshot.hasData){
                                  ...
                                  return "Không tìm thấy sản phẩm".text.wide.makeCentered();
                                }else{
                                   ...
                                   (index) => Column(
                                    ...
                                    children: [
                                      Image.network(
                                        ...
                                        featuredData[index]['p_imgs'][0], width: 130,height: 130, fit: BoxFit.cover),
                                      ...
                                      10.heightBox,
                                      "${featuredData[index]['p_price']}".numCurrency.text.fontFamily(bold).size(16).color(redColor).make(),
                                    ],
                                  ).box.white
                      ...
                      itemBuilder: (context, index) {
                        return Column(
                          ...
                          children: [
                            ...
                            10.heightBox,
                            "${allproductsdata[index]['p_price']}".text.fontFamily(bold).size(16).color(redColor).make(),
                            10.heightBox,
                          ],
